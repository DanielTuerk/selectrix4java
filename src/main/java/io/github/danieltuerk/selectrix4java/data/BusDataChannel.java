 ...
 * io.github.danieltuerk.selectrix4java.data.AbstractSerialAccessTask}. The tasks can be put into the queue to execute by calling
 * {@link io.github.danieltuerk.selectrix4java.data.BusDataChannel#send(BusData)}. The queue is polled after a delay to execute a
 * task. If no task is present in the queue, the channel send the {@link ReadBlockTask} to read the actual values from
 * the SX bus. State changes of the values are published to the given {@link io.github.danieltuerk.selectrix4java.bus.BusDataReceiver}.
 *
 * @author Daniel Tuerk
 */
public class BusDataChannel {
     ...
     * io.github.danieltuerk.selectrix4java.data.ReadBlockTask}.
     */
     ...
     * io.github.danieltuerk.selectrix4java.bus.BusDataReceiver} must be set. Additional receivers can be added at runtime. {@link
     * #addBusDataReceiver}
     *
     * @param serialPort opened {@link SerialPort}
     * @param receiver {@link io.github.danieltuerk.selectrix4java.bus.BusDataReceiver} to receive the values of the read operations
     */
    ...
    /**
     * Send the given {@link io.github.danieltuerk.selectrix4java.data.BusData} to the output of the device. This call is
     * asynchronously executed from the queue.
     *
     * @param busData {@link io.github.danieltuerk.selectrix4java.data.BusData} to send
     */
