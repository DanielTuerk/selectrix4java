...
public interface Device extends Serializable {
    ...
    /**
     * Access to the {@link io.github.danieltuerk.selectrix4java.block.BlockModule} for the given address.
     *
     * @param address address of the block module
     * @return {@link io.github.danieltuerk.selectrix4java.block.BlockModule}
     * @throws DeviceAccessException no access
     */
    BlockModule getBlockModule(int address) throws DeviceAccessException;

    /**
     * Access to the {@link io.github.danieltuerk.selectrix4java.block.FeedbackBlockModule} for the given address.
     *
     * @param address address of the block module
     * @param feedbackAddress address for feedback data
     * @param additionalAddress additional address to receive block states
     * @return {@link io.github.danieltuerk.selectrix4java.block.FeedbackBlockModule}
     * @throws DeviceAccessException no access
     */
     ...
     *
     * @return {@link io.github.danieltuerk.selectrix4java.device.Device.SYSTEM_FORMAT}
     * @throws DeviceAccessException no access
     */
     ...
     * recommended! Use the {@link io.github.danieltuerk.selectrix4java.bus.BusAddressListener}s for an {@link
     * io.github.danieltuerk.selectrix4java.bus.BusAddress} instead of the {@link AbstractBusDataConsumer}s by the {@link
     * io.github.danieltuerk.selectrix4java.bus.BusDataDispatcher}!
     *
     ...
     *
     * @return {@link io.github.danieltuerk.selectrix4java.data.BusDataChannel} or {@code null}
     */
    BusDataChannel getBusDataChannel();

    /**
     * Get or create the {@link io.github.danieltuerk.selectrix4java.bus.BusAddress}.
     *
