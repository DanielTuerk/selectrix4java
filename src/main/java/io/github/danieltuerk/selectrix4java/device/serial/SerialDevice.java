...
/**
 * {@link io.github.danieltuerk.selectrix4java.device.Device} implementation for serial access like COM or USB.
 *
 * @author Daniel Tuerk
 */
public class SerialDevice extends AbstractDevice {
    ...
    /**
     * @see io.github.danieltuerk.selectrix4java.device.Device#disconnect()
     */
    @Override
    ...
    /**
     * Convert the given data value for bits 1-4 to the {@link io.github.danieltuerk.selectrix4java.device.Device.SYSTEM_FORMAT}.
     *
