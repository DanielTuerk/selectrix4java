...
import net.wbz.selectrix4java.jna.LibC;
import net.wbz.selectrix4java.jna.SerialConfig;
import net.wbz.selectrix4java.jna.SerialPortService;
import net.wbz.selectrix4java.jna.Termios;
import net.wbz.selectrix4java.jna.TermiosConst;
