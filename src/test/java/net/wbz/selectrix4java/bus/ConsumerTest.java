 ...
 * Consumers should be called at timestamp of registration and for each changes of the corresponding data. TODO: test
 * for double registration -> single "first call" events
 *
 * @author Daniel Tuerk
 */
public class ConsumerTest extends BaseTest {
    ...
    public void testBusMultiAddressDataConsumer() throws DeviceAccessException, InterruptedException {
        ...
        getDevice().getBusDataDispatcher().registerConsumer(
                new BusMultiAddressDataConsumer(testDataSetAddress1.getSendBus(), testDataSetAddress1.getSendAddress(),
    ...
    private void sendAndAssertEventReceived(TestDataSet testDataSet) throws InterruptedException,
