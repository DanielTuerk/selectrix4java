...
/**
 * Write {@link net.wbz.selecttrix4java.api.data.BusData} to the {@link java.io.OutputStream} of the
 * connected device.
 *
...
public class WriteTask extends AbstractSerialAccessTask<Boolean> {
     ...
     * @param busData      {@link net.wbz.selecttrix4java.api.data.BusData}
     */
