...
public abstract class AbstractDevice implements Device {
    ...
    /**
     * Registered listener of {@link net.wbz.selectrix4java.api.device.DeviceConnectionListener}.
    ...
    /**
     * Establish the connection to the OS and return the {@link net.wbz.selectrix4java.api.data.BusDataChannel}
     * for the open streams.
     *
     * @param busDataDispatcher {@link net.wbz.selectrix4java.api.bus.BusDataDispatcher}
     * @return {@link net.wbz.selectrix4java.api.data.BusDataChannel}
     * @throws DeviceAccessException
     */
     ...
     * <p/>
     * {@link net.wbz.selectrix4java.api.bus.BusAddress} is created by the first access and cached for future access.
     *
    ...
    /**
     * Get {@link net.wbz.selectrix4java.api.train.TrainModule} with actual data for the address.
     * <p/>
     ...
     * Used to register {@link net.wbz.selectrix4java.api.bus.BusDataConsumer}s.
     * <p/>
     * Dispatcher is also available in offline mode and will inform all consumers after an connection is established.
     *
     * @return {@link net.wbz.selectrix4java.api.bus.BusDataDispatcher}
     */
     ...
     *
     * @param listener {@link net.wbz.selectrix4java.api.device.DeviceConnectionListener}
     */
