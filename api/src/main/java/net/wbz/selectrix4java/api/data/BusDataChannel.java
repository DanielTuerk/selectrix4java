 ...
 * Each operation is an {@link net.wbz.selectrix4java.api.data.AbstractSerialAccessTask}.
 ...
 * <p/>
 * State changes of the values are published to the given {@link net.wbz.selectrix4java.api.bus.BusDataReceiver}.
 *
...
//    public static final long DELAY = 500L;
     ...
     * @param receiver     {@link net.wbz.selectrix4java.api.bus.BusDataReceiver} to receive the values of the read operations
     */
    ...
    /**
     * Send the given {@link net.wbz.selectrix4java.api.data.BusData} to the output of the device.
     * This call is asynchronously executed from the queue.
     *
     * @param busData {@link net.wbz.selectrix4java.api.data.BusData} to send
     */
