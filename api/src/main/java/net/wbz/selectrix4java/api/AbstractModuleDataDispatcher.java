...
public class AbstractModuleDataDispatcher<T> {
     ...
     *
     * @param runnable {@link net.wbz.selectrix4java.api.AbstractModuleDataDispatcher.ListenerRunnable}
     */
     ...
     * Is used by the implementing class of {@link net.wbz.selectrix4java.api.AbstractModuleDataDispatcher} to
     * call the method {@link net.wbz.selectrix4java.api.AbstractModuleDataDispatcher#fire(net.wbz.selectrix4java.api.AbstractModuleDataDispatcher.ListenerRunnable)}.
     */
