...
/**
 * {@link net.wbz.selecttrix4java.api.device.Device} implementation for serial access like COM or USB.
 * <p/>
...
public class SerialDevice extends AbstractDevice {
    ...
    public BusDataChannel doConnect(BusDataDispatcher busDataDispatcher) throws DeviceAccessException {
        ...
        if (portList.hasMoreElements()) {
            ...
            try {
                serialPort = (SerialPort) portId.open("net.wbz.selecttrix4java", 2000);
    ...
    /**
     * @see net.wbz.selecttrix4java.api.device.Device#disconnect()
     * <p/>
